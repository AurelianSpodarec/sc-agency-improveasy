...
import useCreatePropertyRating from './hooks/useCreatePropertyRating';

const PropertyCreateRatingModal = () => {
    const { closeModal, handleSubmit, isPosting, error, formState, handleChange } =
        useCreatePropertyRating();

    return (
        <Modal title="Create Rating" size="small">
...
export default PropertyCreateRatingModal;
