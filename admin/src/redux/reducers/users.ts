...
import {
    ...
    fetchUserByPropertyIdFailure,
    fetchUserByPropertyIdRequest,
    fetchUserByPropertyIdSuccess,
    createUserFailure,
    createUserRequest,
    createUserSuccess,
    updateUserFailure,
...
export default createReducer(initialState, {
    ...
    [fetchUserByPropertyIdRequest.type]: handleFetchRequest,
    [fetchUserByPropertyIdSuccess.type]: handleFetchSingleUserSuccess,
    [fetchUserByPropertyIdFailure.type]: handleFetchError,
