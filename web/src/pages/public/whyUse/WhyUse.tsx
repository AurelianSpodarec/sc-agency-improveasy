    ...
    return (
        <MainPublic>
            ...
            <Section size="2xl" className="bg-gradient--primary">
                <Container>
                    <div className="flex-row flex-wrap-md justify-evenly">
                        <div className="flex-4 text-center text-white why-use-pod flex-6-md flex-full-lm">
                            <svg
                                width="120px"
                            ...
                            <div>
                                ...
                                <Text>
                                    Why spend your time searching for reputable installers and
                                    navigating the minefield of available funding. EPC Builder is a
                                    one-stop shop combining surveying, funding and installation.
                                </Text>
                            </div>
                        </div>
                        ...
                        <div className="flex-4 text-center text-white why-use-pod flex-6-md flex-full-lm">
                            ...
                            <div>
                                ...
                                <Text>
                                    One-off fee* payable for the survey which is fully refunded if
                                    the recommended energy efficient home improvements are
                                    installed.
                                    <br />
                                    <br />
                                    Competitive survey and installation costs using our inhouse team
                                    of experienced qualified installers.
                                    <br />
                                    <br />
                                    All available funding checked and applied for, All available
                        ...
                        <div className="flex-4 text-center text-white why-use-pod flex-6-md flex-full-lm">
                            ...
                            <div>
                                ...
                                <Text>
                                    Our in-house installation team are accredited by Trustmark, MCS
                                    and PAS.
                                    <br />
                                    <br />
                                    2-year workmanship guarantee in addition to the manufacturers
                                    warranty.
                                </Text>
                            </div>
                        </div>
                    ...
                    <div className="md:d-flex space-y-10 md:space-y-0 md:space-x-20">
                        ...
                        <div className="w-full md:w-1/2">
                            <div>
                                ...
                                <Text size="lg">
                                    Access to expert team who will hold your hand every step of the
                                    way, answer queries and liaise with your tenant (if applicable).
                                    <br />
                                    <br />
                                    Centralised account to store all property documents e.g., house
                                    insurance
                                </Text>
                            </div>
