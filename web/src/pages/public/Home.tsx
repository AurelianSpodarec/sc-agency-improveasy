        ...
        <>
                ...
                <Container>
                    <div className="d-flex">
                        ...
                        <div className="text-center text-white">
                            <svg width="120px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="robot-astromech" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
                        ...
                        <div className="text-center text-white">
                            <svg width="120px" aria-hidden="true" focusable="false" data-prefix="far" data-icon="universal-access" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <div>
                                <Text type="h3">Tost effective</Text>
                                <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</Text>
                            </div>
                        </div>
                        ...
                        <div className="text-center text-white">
                            ...
                            <div>
                                <Text type="h3">Peace of mind</Text>
                                <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</Text>
                            </div>
                        </div>
            ...
            <Container>
                ...
                <div>
                    ...
                    <div>
                        <img width="400px" className="rounded-primary" src="https://images.unsplash.com/photo-1613754537171-88192258d85b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2871&q=80" alt="Image" />
                    </div>
                    <div>
                        <div>
