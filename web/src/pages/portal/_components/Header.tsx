            ...
            <Container style={{ height: '100%' }}>
                <div className="header__inner flex justify-between items-center">
                        ...
                        <Link to="/">
                            ...
                            >
                                <defs>
                                    ...
                                    >
                                        <stop offset="0" stopColor="#2a9c8e" />
                                        <stop offset="0.1" stopColor="#228e80" />
                                        <stop offset="0.33" stopColor="#137366" />
                                        <stop offset="0.47" stopColor="#0d695c" />
                                        <stop offset="0.64" stopColor="#1a5657" />
                                        <stop offset="0.82" stopColor="#234a54" />
                    ...
                    <div className="profile flex-row align-center">
                        <button type="button" onClick={e => handlerCreateProperty(e)}>
                            Create Property
                        </button>
